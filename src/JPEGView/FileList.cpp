...
static const int cnNumEndingsInternal = 23;
static const TCHAR* csFileEndingsInternal[cnNumEndingsInternal] = {
	_T("jpg"), _T("jpeg"), _T("png"),
	_T("cbz"), _T("cb7"),
	_T("avif"), _T("bmp"), _T("gif"), _T("heic"), _T("heif"), _T("ico"), _T("jfif"), _T("jxl"), _T("kra"), _T("psb"), _T("psd"), _T("qoi"), _T("svg"), _T("svgz"), _T("tif"), _T("tiff"), _T("tga"), _T("webp")};
